...
public class DBUtil {
    ...
    private static final String URL = "jdbc:mysql://localhost/musicdb?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false&allowPublicKeyRetrieval=true";
